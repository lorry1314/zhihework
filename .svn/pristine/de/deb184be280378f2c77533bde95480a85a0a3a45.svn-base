 ...
 *
 */
public class XunGengActivity extends MBaseActivity implements View.OnClickListener, HttpListener {
	...
	private XunGengActivity mContext;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xungeng_layout);
	...
	private void initView() {
		findViewById(R.id.xungeng_erweima).setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.regis_back:
			finish();
			break;
		case R.id.xungeng_erweima:
			setClass(mContext, XunGeng_erweima_Activity.class);
			break;
		}
	}
