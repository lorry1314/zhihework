...
public class CirclePresenter {
	...
	/**
	 * 
	 * @Title: deleteCircle @Description: 删除动态 @param circleId @return void
	 * 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: addFavort @Description: 点赞 @param circlePosition @return void
	 * 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: deleteFavort @Description: 取消点赞 @param @param
	 * circlePosition @param @param favortId @return void 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: addComment @Description: 增加评论 @param circlePosition @param type
	 * 0：发布评论 1：回复评论 @param replyUser 回复评论时对谁的回复 @return void 返回类型 @throws
	 */
	...
	/**
	 * 
	 * @Title: deleteComment @Description: 删除评论 @param @param
	 * circlePosition @param @param commentId @return void 返回类型 @throws
	 */
