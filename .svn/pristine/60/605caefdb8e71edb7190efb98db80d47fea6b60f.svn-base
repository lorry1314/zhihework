package com.zorgoom.circle.widgets;

import java.util.ArrayList;

import com.zorgoom.circle.bean.ActionItem;
import com.zorgoom.circle.utils.DensityUtil;
...
public class SnsPopupWindow extends PopupWindow implements OnClickListener {
	...
	public SnsPopupWindow(Context context) {
		View view = LayoutInflater.from(context).inflate(R.layout.cf_social_sns_popupwindow, null);
