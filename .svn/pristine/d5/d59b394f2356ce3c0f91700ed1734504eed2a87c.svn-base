...
import com.zorgoom.zhihework.photoview.PhotoView;
...
public class ImagePagerActivity extends Activity {
	...
	private static class ImageAdapter extends PagerAdapter {
		...
		public ImageAdapter(Context context) {
			...
			options = new DisplayImageOptions.Builder().showImageForEmptyUri(R.drawable.first_image)
					.showImageOnFail(R.drawable.first_image).resetViewBeforeLoading(true)
					// .cacheOnDisk(true)
