...
public class NoticeListAdapter extends BaseAdapter {
	...
	public NoticeListAdapter(Context context, List<Msg> list2) {
		this.list = list2;
		// 布局填充图
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		blurb.title.setText(infoVO.getNOTICETITLE());// 内容
		blurb.date.setText(infoVO.getCREDATE());
		blurb.content.setText(infoVO.getREMARK());
		return convertView;
	}
