 ...
 */
@SuppressLint("NewApi")
public class QingJiaList extends MBaseActivity implements View.OnClickListener, HttpListener {

	private ListView message_listView1;
	// private C2BHttpRequest c2BHttpRequest;
	private QingJiaList mContext;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.qingjia_layout);
		mContext = this;
		initView();
	...
	// Http.GETALLLEASEHOUSE + "COMMUNITYID=" + COMMUNITYID + "&FKEY=" + key +
	...
	// long id) {
	// Intent intent = new Intent(mContext, QingJia_detail.class);
	// intent.putExtra("msg",
	...
	public void onClick(View v) {
		...
		case R.id.add_maintain://
			openActivity(QingJiaAddActivity.class);
			break;
	...
	public void OnResponse(String result, int reqId) {
		...
		// return;
		// }
		// QingjiaAdapter myadapter = new QingjiaAdapter(this,
