package com.zorgoom.circle.contral;


import com.zorgoom.app.App;
import com.zorgoom.circle.CfMainActivity;
...
public class CirclePublicCommentContral {
	...
	* @throws
	...
	public void handleListViewScroll() {
		int keyH = App.mKeyBoardH;//键盘的高度
		int editTextBodyH = ((CfMainActivity)mContext).getEditTextBodyHeight();//整个EditTextBody的高度
		int screenlH = ((CfMainActivity)mContext).getScreenHeight();//整个应用屏幕的高度
