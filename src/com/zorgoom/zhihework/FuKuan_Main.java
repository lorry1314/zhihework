...
public class FuKuan_Main extends MBaseActivity implements View.OnClickListener, HttpListener {

	private SwipeRefreshLayout main_srl_view;
	private ImageView pay_erweima;
	private C2BHttpRequest c2BHttpRequest;
	private FuKuan_Main mContext;

	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.fukuan_main);
			...
			case 2:
				...
				if (code != null) {
					if ("101".equals(code.getCode())) {
						...
						Intent intent = new Intent(mContext, ConsumeDetail_detail.class);
						intent.putExtra("checkCode", code.getData());
						startActivity(intent);
					} else {
						ToastUtil.showMessage(mContext, code.getMsg());
					}
				}
				break;
			}
