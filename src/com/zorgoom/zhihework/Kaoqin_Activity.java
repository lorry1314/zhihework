...
public class Kaoqin_Activity extends BaseActivity implements View.OnClickListener, HttpListener {

	private Kaoqin_Activity mContext;
//	private TextView time, time2, date, date2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = this;
		setContentView(R.layout.kaoqin_layout);
//		new TimThread().start();
		initView();
	}
...
//		date2.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.regis_back:
			...
			break;
		case R.id.bt1:// 请假条
			setClass(mContext, QingJiaList.class);
			break;
		case R.id.bt2:// 二维码
			setClass(mContext, KaoQin_Main2.class);
			break;
		case R.id.bt3:// 打卡时间查询
			setClass(mContext, DaKaJiLuActivity.class);
			break;
		case R.id.bt4:// 出勤统计
			setClass(mContext, ChuQintj_Activity.class);
			break;
		case R.id.bt5:// 奖惩信息
			setClass(mContext, JangChen_Activity.class);
			break;
		case R.id.bt6:// 反馈
