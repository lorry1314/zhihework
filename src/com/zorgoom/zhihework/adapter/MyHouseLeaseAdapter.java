...
public class MyHouseLeaseAdapter extends BaseAdapter {

	private LayoutInflater inflater;
	private List<HouseLease> list;

	public MyHouseLeaseAdapter(Context context, List<HouseLease> list2) {
		this.list = list2;
		// 布局填充图
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			blurb = new Blurb();
//			convertView = inflater.inflate(R.layout.my_house_lease_item, null);
