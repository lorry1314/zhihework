...
public class ChuQintj_Activity extends BaseActivity implements View.OnClickListener, HttpListener {

	private ChuQintj_Activity mContext;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = this;
		setContentView(R.layout.chuqintj_layout);
//		new TimThread().start();
		initView();
	}
