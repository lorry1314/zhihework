...
public class MyRegister_Activity extends BaseActivity implements HttpListener, View.OnClickListener, Callback {
...
//		et_verification_code = (EditText) findViewById(R.id.et_verification_code);
		...
		regis_putphone = (EditText) findViewById(R.id.regis_putphone);// �ֻ�����
		regis_next = (TextView) findViewById(R.id.regis_next);// ��һ��
//		ctv_verify = (TextView) findViewById(R.id.ctv_verify);// ��һ��
...
//			break;
	...
	private void register() {
		if ("".equals(user_phone) || user_phone == null) {
			ToastUtil.showMessage1(MyRegister_Activity.this, "手机号码不能为空", 300);
			return;
		}
		if ("".equals(uName) || uName == null) {
			ToastUtil.showMessage1(MyRegister_Activity.this, "用户名不能为空", 300);
			return;
		}
		if ("".equals(userName) || userName == null) {
			ToastUtil.showMessage1(MyRegister_Activity.this, "真实姓名不能为空", 300);
			return;
		}
		if ("".equals(pwd1) || pwd1 == null) {
			ToastUtil.showMessage1(MyRegister_Activity.this, "密码不能为空", 300);
			return;
		}
		if ("".equals(pwd2) || pwd2 == null) {
			ToastUtil.showMessage1(MyRegister_Activity.this, "确认密码不能为空", 300);
			return;
		}
		if (!pwd2.equals(pwd1)) {
			ToastUtil.showMessage1(MyRegister_Activity.this, "两次密码输入不一样", 300);
			return;
		}
...
//		params.addBodyParameter("MOBILE", user_phone);
		params.addBodyParameter("TEL", user_phone);
